...
const OUT_DIR = "C:/Users/Admin/Downloads/zenith-catalog-glow-main (1)/zenith-catalog-glow-main/.tmp/browser-check";
...
for (const viewport of viewports) {
  ...
  for (const route of routes) {
    if (route.requiresLogin && !loggedIn) {
      ...
      await page.goto(`${APP_URL}/admin/dashboard`, { waitUntil: "networkidle", timeout: 30000 });
      loggedIn = true;
    } else {
