...
public class RazorpayPaymentService {
  ...
  public boolean verifyPaymentSignature(String razorpayOrderId, String razorpayPaymentId, String signature) {
    ...
    String expected = hmacSha256Hex(razorpayOrderId + "|" + razorpayPaymentId,
  ...
  public boolean verifyWebhookSignature(String rawBody, String signature) {
    ...
    String expected = hmacSha256Hex(rawBody, appProperties.getRazorpay().getWebhookSecret());
    return constantTimeEquals(expected, signature);
  }
